...
s=s.sort_values('median_rho_across_c1_terms',ascending=False,kind='stable',na_position='last').reset_index(drop=True)
...
for i in range(48):
 ...
 if r.number_estimable_c1_terms>0:
  ax.hlines(i,r.min_rho,r.max_rho,color=color,lw=2.2,zorder=2)
  ax.scatter(r.median_rho_across_c1_terms,i,s=35,color=color,edgecolors='white',linewidth=.5,zorder=3)
...
for a in [ax,ann]:a.set_ylim(47.6,-.8)
